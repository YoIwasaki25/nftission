...
const Home = () => {
  return (
    <div className="pt32 pb-12 md:pt-40 md:pb-20">
      <div className="pb-12 text-center md:pb16">
        <h1 className="leading-tight mb-4 text-7xl font-extrabold tracking-tighter md:text-8xl">
          <span className="bg-gradient-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent">
            NFTission
          </span>
        </h1>
        <div className="mx-auto max-w-3xl">
          <p className="mb-8 text-xl">You can find favorite NFT Arts!</p>
